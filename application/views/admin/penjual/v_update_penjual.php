        ...
        <div id="content">
            ...
            <div class="card shadow mb-4 col-sm-10" style="margin-left: 100px;">
                <div class="card-header py-3">
                    <h4 class="m-0 font-weight-bold text-primary text-center">Update Daftar Penjual </h4>
                </div>
                <div class="card-body">
                    ...
                    <form method="post">
                        ...
                        <div class="form-group">
                            ...
                            <input type="hidden" name="id" id="id" value="<?= $penjual['id_user']; ?>">
                            <input type="text" name="username" class="form-control" id="username" value="<?= $penjual['username']; ?>">
                            <?= form_error('username', '<small class="text-danger">', '</small>'); ?>
                        </div>
                        <div class="form-group">
                            <label for="nama">Nama</label>
                            <input type="text" name="nama" class="form-control" id="nama" value="<?= $penjual['nama']; ?>">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" name="telephone" class="form-control" id="telephone" value="<?= $penjual['telephone']; ?>">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="alamat" class="form-control" id="alamat" value="<?= $penjual['alamat']; ?>">
                            <?= form_error('alamat', '<small class="text-danger">', '</small>'); ?>
                            <small id="alamat" class="form-text text-muted">Masukkan alamat lengkap anda </small>
                        </div>
                        <div class="form-group">
                            <label for="email">E-mail</label>
                            <input type="text" name="email" class="form-control" id="email" value="<?= $penjual['email']; ?>" />
                            <?= form_error('email', '<small class="text-danger">', '</small>'); ?>
                        </div>
                        <!-- <div class="form-group">
                            <label for="password">Masukkan Password</label>
                            <input type="hidden" name="password1" class="form-control" value="<?= $penjual['password']; ?>" />

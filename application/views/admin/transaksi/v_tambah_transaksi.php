        ...
        <div id="content">
            ...
            <div class="card shadow mb-4 col-sm-10" style="margin-left: 100px;">
                <div class="card-header py-3">
                    <h4 class="m-0 font-weight-bold text-primary text-center">Tambah Data Transaksi </h4>
                </div>
                <div class="card-body">
                    <div class="text-center">
                        <?= $this->session->flashdata('message'); ?>
                    </div>
                    <form action="<?= base_url() ?>Admin/tambahDatatransaksi" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <small id="id_penjual" class="form-text text-muted"></small>
                        </div>
                        <div class="form-group">
                            <label for="id_pembeli">ID Pembeli</label>
                            <input type="number" name="id_pembeli" class="form-control" id="id_pembeli">
                            <?= form_error('id_pembeli', '<small class="text-danger">', '</small>'); ?>
                            <small id="id_pembeli" class="form-text text-muted"></small>
                        </div>
                        <div class="form-group">
                            ...
                            <small id="nama_penjual" class="form-text text-muted">Masukkan alamat lengkap anda </small>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="alamat_pengiriman" class="form-control" id="alamat_pengiriman">
                        ...
                        <div class="col-sm-4 offset-5">
                            ...
                            <a href="Admin/tampilTransaksi" class="btn mt-3 mb-2"> Batal </a>
                    </form>
                </div>
            </div>
        </div>

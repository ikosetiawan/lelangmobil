        ...
        <div id="content">
            ...
            <div class="card shadow mb-4 col-sm-10" style="margin-left: 100px;">
                <div class="card-header py-3">
                    <h4 class="m-0 font-weight-bold text-primary text-center">Tambah Data Pembeli </h4>
                </div>
                <div class="card-body">
                    <div class="text-center">
                        <?= $this->session->flashdata('message'); ?>
                    </div>
                    <form action="<?= base_url() ?>Admin/tambahDataPembeli" method="post">
                        ...
                        <div class="col-sm-4 offset-5">
                            ...
                            <a href="<?= base_url() ?>Admin/tampilPembeli" class="btn mt-3 mb-2">Batal </a>
                    </form>
                </div>
            </div>
        </div>

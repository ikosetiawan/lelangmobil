        ...
        <div id="content">
            ...
            <div class="card shadow mb-4 col-sm-10" style="margin-left: 100px;">
                ...
                <div class="card-body">
                        ...
                        foreach ($barang as $brg) : ?>
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td><?= $brg['harga']; ?></td>
                                    <td><a href="<?= base_url(); ?>Admin/updateBarang/<?= $brg['id_barang']; ?>" class="badge badge-primary ">Update</a></td>
                                    <td><a href="<?= base_url(); ?>Admin/hapusBarang/<?= $brg['id_barang']; ?>" class="badge badge-danger " onclick="return confirm('yakin');">Hapus</a></td>
                                </tr>
                            </tbody>
                        <?php $no++;
                        endforeach; ?>
                    ...
                    <div class="text-center">
                        <a href="<?= base_url() ?>Admin/tambahDataBarang" class="btn btn-primary"> Tambah Data Barang </a>
                        <a href="<?= base_url() ?>Admin/barangPdf" class="btn btn-danger ml-3"><i class="fa fa-file"></i> Print PDF </a>
                    </div>
                </div>
            </div>
        </div>

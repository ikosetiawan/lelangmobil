...
<div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
        ...
        <!-- Nav Item - Tables -->
        <li class="nav-item">
            <a class="nav-link" href="<?= base_url(); ?>Admim/tampilTransaksi">
                <i class="fas fa-fw fa-table"></i>
        ...
        <div id="content">
            ...
            <div class="card shadow mb-4 col-sm-10" style="margin-left: 100px;">
                ...
                <div class="card-body">
                    ...
                    <form action="<?= base_url() ?>Admin/tambahDatabarang" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-group" name="deskripsi" id="deskripsi" cols="138" rows="12">
                            </textarea>
                            <?= form_error('deskripsi', '<small class="text-danger">', '</small>'); ?>
                        </div>
                        <div class="col-sm-4 offset-5">
                            <button type="submit" name="ubah" class="btn btn-primary mt-3 mb-2"> Tambah </button>
                            <a href="Admin/tampilBarang" class="btn mt-3 mb-2"> Batal </a>
                        </div>
                    </form>
                </div>
            </div>
